#tutto in Py è implementato utilizando le classi
#-> cioè str, int, bool funzioni e tutto quello al seguito SONO classi
...
""" COME ACCEDERE AL MANUALE DI PYTHON:
Console -> py ->dir('classe' ad esempio 'str') -> help('metodo' ad esempio 'str.split')"""

print(abc.split(sep=' '))                   #OUTPUT: ['ciao', 'come', 'stai?']

print(abc.split(sep=' ', maxsplit=1))       #OUTPUT: ['ciao', 'come stai?']

print(abc.replace(' ', ''))                 #OUTPUT: ciaocomestai?

#COME OTTENERE: ciao come, stai?

new_abc = abc.rsplit(sep=' ', maxsplit=1)
print(new_abc)                              #OUTPUT: ['ciao come', 'stai?']

#is numeric? restituisce un bool (quindi restituisce T/F)
...
#           2)          Utilizzare un loop x controllare corretteza quantità e richiedere eventuale input
#           3)          Cosa succede se metto una , come separatore
